...
define('G5_MYSQL_USER', 'parkmobc');
define('G5_MYSQL_PASSWORD', '@cA:UrwqemC,dG5');
define('G5_MYSQL_DB', 'parkmobc_home');
define('G5_MASTER_PW', '');
define('G5_DB_URL', 'https://cpanel-box2285.bluehost.com/cpsess4964195816/3rdparty/phpMyAdmin/index.php');
...
$g5['cal_table'] = G5_TABLE_PREFIX.'cal'; // 캘린더 정보 테이블
