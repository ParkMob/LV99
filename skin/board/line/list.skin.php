...
<? } ?>
	...
	<div class="ui-top theme-box"><? if ($write_href) { 
		...
		<form name="fsearch" method="get" style="margin:0px;">
			...
			<input type="text" name="stx" itemname="검색어" value="<?=$stx?>" ><??><button type="submit" class="ui-btn"><i class="fas fa-search"></i></button>
		</form> 
	</div></div>
	<? } 
	?>
				...
				<li class="theme-box">
					<form name="fboardlist" method="post" action="<?=$board_skin_url?>/password.php" style="margin:0">
						...
						<div class="memo-content content-area">
							...
							?> 
								<a href="#" class="write_open">***</a><p class="pass_in"><input type="password" name="wr_password" id="wr_password_<?=$ii?>" value="" placeholder="비밀번호"/>
