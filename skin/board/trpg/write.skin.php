...
<section id="bo_w">
	...
	<div class="board-write theme-box">
        ...
        <input type="text" name="wr_2" value= "<?php echo $wr_2 ?>" id="wr_2" class="frm_input" size="15" placeholder="시작시각" style="display:inline-block; margin-right:10px;">
        <div class="name_tag">
        종료시각
        </div> 
        <input type="text" name="wr_3" value= "<?php echo $wr_3 ?>" id="wr_3" class="frm_input" size="15" placeholder="종료시각" style="display:inline-block; margin-right:10px;">
		<div class="name_tag">
        총 소요시간
        </div> 
        <input type="text" name="wr_1" value= "<?php echo $wr_1 ?>" id="wr_1" class="frm_input" size="10" placeholder="소요시간" style="display:inline-block; margin-right:10px;">
        ...
        <input type="text" name="wr_4" value= "<?php echo $wr_4 ?>" id="wr_2" class="frm_input" size="20" placeholder="GM(NPC)" style="display:inline-block; margin-right:10px;">
        <div class="name_tag">
        PL(PC)
        </div> 
        <input type="text" name="wr_5" value= "<?php echo $wr_5 ?>" id="wr_5" class="frm_input" size="25" placeholder="PL(PC)" style="display:inline-block; margin-right:10px;">

		</nav>

		<!-- <div class="wr_content"  style="margin-top: 10px;">
        <textarea name="wr_6" id="wr_6" required class="frm_input" cols="50" rows="10" style="width:100%; height:100px;" placeholder="시나리오 개요"><?php echo $wr_6 ?></textarea>
		</div> -->
...
$(document).ready(function(){
    ...
    if($("#set_secret option").index($("#set_secret option:selected"))==2){
            document.getElementById("wr_protect").style.display = "block";
        }

    $("select[id='set_secret']").change(function(){
        if($("#set_secret option").index($("#set_secret option:selected"))==2){
            document.getElementById("wr_protect").style.display = "block";
        }else{
            document.getElementById("wr_protect").style.display = "none";
        }
    });
