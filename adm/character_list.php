...
<div class="btn_add01 btn_add">
    <a href="<?=G5_URL?>/mypage/character/character_form.php" id="member_add">캐릭터추가</a>
</div>
<?php } ?>
...
<? } ?>
	...
	for ($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$s_mod = '<a href="'.G5_URL.'/mypage/character/character_form.php?w=u&ch_id='.$row['ch_id'].'">수정</a>';
