...
$sql_order = " order by bo_order $sod ";
...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		...
		<th scope="col"><?php echo subject_sort_link('bo_order_whippy') ?>메뉴 표시</a></th>
        
		<th scope="col">순서<span class="sound_only">순서</span></th>
	...
	<tr class="<?php echo $bg; ?>">
        ...
        <td>
			<label for="bo_order_whippy_<?php echo $i; ?>" class="sound_only">메뉴 표시</label>
            <input type="checkbox" name="bo_order_whippy[<?php echo $i ?>]" value="1" <?php echo $row['bo_order_whippy']?'checked':'';?> id="bo_order_whippy[<?php echo $i ?>]" >
		</td>
		<td>
			<label for="bo_order_whippy_<?php echo $i; ?>" class="sound_only">게시판 순서</label>
			<input type="text" name="bo_order[<?php echo $i ?>]" value="<?php echo $row['bo_order'] ?>" id="bo_order<?php echo $i; ?>" class="frm_input" size="2">
		</td>
		<!-- <td>
