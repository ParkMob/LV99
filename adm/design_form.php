...
$pg_anchor = '<ul class="anchor">
    ...
    <li><a href="#anc_007">TRPG 디자인</a></li>
    <li><a href="#anc_008">캘린더 디자인</a></li>
	...
	<div class="tbl_frm01 tbl_wrap">
		<table>
			...
			<tbody>
				...
				<td rowspan="2" class="bo-right">
					<input type="text" name="cs_name[43]" value="cate_background" readonly size="15"/>
				</td>
				<td>
					텍스트색상&nbsp;&nbsp; <input type="text" name="cs_value[43]" value="<?=$de['cate_background']['cs_value']?>" size="10"/>
					<i class="color-preview" style="background: <?=$de['cate_background']['cs_value']?>;"></i>
					&nbsp;&nbsp;

					배경색상&nbsp;&nbsp; <input type="text" name="cs_etc_1[43]" value="<?=$de['cate_background']['cs_etc_1']?>" size="10"/>
					<i class="color-preview" style="background: <?=$de['cate_background']['cs_etc_1']?>;"></i>
					&nbsp;&nbsp;

                    폰트크기&nbsp;&nbsp; <input type="text" name="cs_etc_2[43]" value="<?=$de['cate_background']['cs_etc_2']?>" size="5"/> px
				...
				<td>
					텍스트색상&nbsp;&nbsp; <input type="text" name="cs_etc_3[43]" value="<?=$de['cate_background']['cs_etc_3']?>" size="10"/>
					<i class="color-preview" style="background: <?=$de['cate_background']['cs_etc_3']?>;"></i>
					&nbsp;&nbsp;

					배경색상&nbsp;&nbsp; <input type="text" name="cs_etc_4[43]" value="<?=$de['cate_background']['cs_etc_4']?>" size="10"/>
					<i class="color-preview" style="background: <?=$de['cate_background']['cs_etc_4']?>;"></i>
					&nbsp;&nbsp;

					
                    폰트크기&nbsp;&nbsp; <input type="text" name="cs_etc_5[43]" value="<?=$de['cate_background']['cs_etc_5']?>" size="5"/> px
				</td>
            </tr>
            ...
            <tr>
					...
					<td class="bo-right">
						<input type="text" name="cs_name[44]" value="cate_join" readonly size="15"/>
					</td>
					<td>
                    문자&nbsp;&nbsp; <input type="text" name="cs_value[44]" value="<?=$de['cate_join']['cs_value']?>" size="5"/>
                    &nbsp;&nbsp;
						색상코드&nbsp;&nbsp; <input type="text" name="cs_etc_1[44]" value="<?=$de['cate_join']['cs_etc_1']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['cate_join']['cs_etc_1']?>;"></i>
						&nbsp;&nbsp;
						폰트크기&nbsp;&nbsp; <input type="text" name="cs_etc_2[44]" value="<?=$de['cate_join']['cs_etc_2']?>" size="5"/> px
                ...
                <tr>
					...
					<td rowspan="3" class="bo-right bo-left txt-center">
						<? if($de['m_slide_background']['cs_value']) { ?>
							<img src="<?=$de['m_slide_background']['cs_value']?>" class="prev_thumb"/>
						<? } else { ?>
						이미지 미등록
						<? } ?>
					</td>
					<td rowspan="3" class="bo-right">
						<input type="text" name="cs_name[46]" value="m_slide_background" readonly size="15"/>
					</td>
					<td>
						직접등록&nbsp;&nbsp; <input type="file" name="cs_value_file[46]" value="" size="50">
					</td></tr><tr>
					<td>
						외부경로&nbsp;&nbsp; <input type="text" name="cs_value[46]" value="<?=$de['m_slide_background']['cs_value']?>" size="50"/>				
					</td></tr><tr>
					<td>
						색상코드&nbsp;&nbsp; <input type="text" name="cs_etc_1[46]" value="<?=$de['m_slide_background']['cs_etc_1']?>" size="46"/>
						<i class="color-preview" style="background: <?=$de['m_slide_background']['cs_etc_1']?>;"></i>
						&nbsp;&nbsp;

						배경반복&nbsp;&nbsp;
						<select name="cs_etc_2[46]">
							<option value="">반복</option>
							<option value="no-repeat" <?=$de['m_slide_background']['cs_etc_2'] == 'no-repeat' ? "selected" : ""?>>반복없음</option>
							<option value="repeat-x"  <?=$de['m_slide_background']['cs_etc_2'] == 'repeat-x' ? "selected" : ""?>>가로반복</option>
							<option value="repeat-y"  <?=$de['m_slide_background']['cs_etc_2'] == 'repeat-y' ? "selected" : ""?>>세로반복</option>
						</select>
						&nbsp;&nbsp;

						배경위치&nbsp;&nbsp;
						<select name="cs_etc_3[46]">
							<option value="">왼쪽 상단</option>
							<option value="left middle"		<?=$de['m_slide_background']['cs_etc_3'] == 'left middle' ? "selected" : ""?>>왼쪽 중단</option>
							<option value="left bottom"		<?=$de['m_slide_background']['cs_etc_3'] == 'left bottom' ? "selected" : ""?>>왼쪽 하단</option>

							<option value="center top"		<?=$de['m_slide_background']['cs_etc_3'] == 'center top' ? "selected" : ""?>>중간 상단</option>
							<option value="center center"	<?=$de['m_slide_background']['cs_etc_3'] == 'center center' ? "selected" : ""?>>중간 중단</option>
							<option value="center bottom"	<?=$de['m_slide_background']['cs_etc_3'] == 'center bottom' ? "selected" : ""?>>중간 하단</option>

							<option value="right top"		<?=$de['m_slide_background']['cs_etc_3'] == 'right top' ? "selected" : ""?>>오른쪽 상단</option>
							<option value="right middle"	<?=$de['m_slide_background']['cs_etc_3'] == 'right middle' ? "selected" : ""?>>오른쪽 중단</option>
							<option value="right bottom"	<?=$de['m_slide_background']['cs_etc_3'] == 'right bottom' ? "selected" : ""?>>오른쪽 하단</option>
						</select>
						&nbsp;&nbsp;

						배경크기&nbsp;&nbsp;
						<select name="cs_etc_4[46]">
							<option value="">원본크기</option>
							<option value="contain"		<?=$de['m_slide_background']['cs_etc_4'] == 'contain' ? "selected" : ""?>>맞춤</option>
							<option value="cover"		<?=$de['m_slide_background']['cs_etc_4'] == 'cover' ? "selected" : ""?>>꽉참</option>
							<option value="100% 100%"	<?=$de['m_slide_background']['cs_etc_4'] == '100% 100%' ? "selected" : ""?>>늘이기</option>
						</select>
						&nbsp;&nbsp;

						고정&nbsp;&nbsp;
						<select name="cs_etc_5[46]">
							<option value="">스크롤</option>
							<option value="fixed"		<?=$de['m_slide_background']['cs_etc_5'] == 'fixed' ? "selected" : ""?>>고정</option>
						</select>
					</td>
				</tr>
				...
				<td rowspan="2" class="bo-right">
					<input type="text" name="cs_name[47]" value="m_slide_menu" readonly size="15"/>
				</td>
				<td>
					텍스트색상&nbsp;&nbsp; <input type="text" name="cs_value[47]" value="<?=$de['m_slide_menu']['cs_value']?>" size="10"/>
					<i class="color-preview" style="background: <?=$de['m_slide_menu']['cs_value']?>;"></i>
					&nbsp;&nbsp;

					&nbsp;&nbsp;

                    폰트크기&nbsp;&nbsp; <input type="text" name="cs_etc_1[47]" value="<?=$de['m_slide_menu']['cs_etc_1']?>" size="5"/> px
				...
				<td>
					배경색&nbsp;&nbsp; <input type="text" name="cs_etc_2[47]" value="<?=$de['m_slide_menu']['cs_etc_2']?>" size="10"/>
					<i class="color-preview" style="background: <?=$de['m_slide_menu']['cs_etc_2']?>;"></i>
					&nbsp;&nbsp;

					라인 색&nbsp;&nbsp; <input type="text" name="cs_etc_3[47]" value="<?=$de['m_slide_menu']['cs_etc_3']?>" size="10"/>
					<i class="color-preview" style="background: <?=$de['m_slide_menu']['cs_etc_3']?>;"></i>
					&nbsp;&nbsp;

					
                    선 굵기&nbsp;&nbsp; <input type="text" name="cs_etc_4[47]" value="<?=$de['m_slide_menu']['cs_etc_4']?>" size="4"/> px
				</td>
            </tr>
            ...
            <tr>
				...
				<td rowspan="2" class="bo-right">
					<input type="text" name="cs_name[48]" value="m_slide_cate" readonly size="15"/>
				</td>
				<td>
					텍스트색상&nbsp;&nbsp; <input type="text" name="cs_value[48]" value="<?=$de['m_slide_cate']['cs_value']?>" size="10"/>
					<i class="color-preview" style="background: <?=$de['m_slide_cate']['cs_value']?>;"></i>
					&nbsp;&nbsp;

					&nbsp;&nbsp;

                    폰트크기&nbsp;&nbsp; <input type="text" name="cs_etc_1[48]" value="<?=$de['m_slide_cate']['cs_etc_1']?>" size="5"/> px
				...
				<td>
					배경색&nbsp;&nbsp; <input type="text" name="cs_etc_2[48]" value="<?=$de['m_slide_cate']['cs_etc_2']?>" size="10"/>
					<i class="color-preview" style="background: <?=$de['m_slide_cate']['cs_etc_2']?>;"></i>
					&nbsp;&nbsp;

					라인 색&nbsp;&nbsp; <input type="text" name="cs_etc_3[48]" value="<?=$de['m_slide_cate']['cs_etc_3']?>" size="10"/>
					<i class="color-preview" style="background: <?=$de['m_slide_cate']['cs_etc_3']?>;"></i>
					&nbsp;&nbsp;

					
                    선 굵기&nbsp;&nbsp; <input type="text" name="cs_etc_4[48]" value="<?=$de['m_slide_cate']['cs_etc_4']?>" size="4"/> px
				</td>
            </tr>
            ...
            <tr>
					...
					<td class="bo-right">
						<input type="text" name="cs_name[49]" value="m_slide_btn" readonly size="15"/>
					</td>
					<td>
     
						색상코드&nbsp;&nbsp; <input type="text" name="cs_value[49]" value="<?=$de['m_slide_btn']['cs_value']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['m_slide_btn']['cs_value']?>;"></i>
						&nbsp;&nbsp;
						폰트크기&nbsp;&nbsp; <input type="text" name="cs_etc_1[49]" value="<?=$de['m_slide_btn']['cs_etc_1']?>" size="5"/> px
...
<?php echo $frm_submit; ?>
<section id="anc_007">
	<h2 class="h2_frm">TRPG 디자인 설정</h2>
	<?php echo $pg_anchor ?>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td class="bo-right">
						<input type="text" name="cs_name[50]" value="roll_desc" readonly size="15"/>
					</td>
					<td>
						배경색상&nbsp;&nbsp; <input type="text" name="cs_value[50]" value="<?=$de['roll_desc']['cs_value']?>" size="8"/>
						<i class="color-preview" style="background: <?=$de['roll_desc']['cs_value']?>;"></i>
						&nbsp;&nbsp;
						폰트색상&nbsp;&nbsp; <input type="text" name="cs_etc_1[50]" value="<?=$de['roll_desc']['cs_etc_1']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['roll_desc']['cs_etc_1']?>;"></i>
                ...
                <tr>
					...
					<td class="bo-right">
						<input type="text" name="cs_name[51]" value="roll_em" readonly size="15"/>
					</td>
					<td>
						배경색상&nbsp;&nbsp; <input type="text" name="cs_value[51]" value="<?=$de['roll_em']['cs_value']?>" size="8"/>
						<i class="color-preview" style="background: <?=$de['roll_em']['cs_value']?>;"></i>
						&nbsp;&nbsp;
						폰트색상&nbsp;&nbsp; <input type="text" name="cs_etc_1[51]" value="<?=$de['roll_em']['cs_etc_1']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['roll_em']['cs_etc_1']?>;"></i>
                ...
                <tr>
					...
					<td class="bo-right">
						<input type="text" name="cs_name[52]" value="roll_my_msg" readonly size="15"/>
					</td>
					<td>
						배경색상&nbsp;&nbsp; <input type="text" name="cs_value[52]" value="<?=$de['roll_my_msg']['cs_value']?>" size="8"/>
						<i class="color-preview" style="background: <?=$de['roll_my_msg']['cs_value']?>;"></i>
						&nbsp;&nbsp;
						폰트색상&nbsp;&nbsp; <input type="text" name="cs_etc_1[52]" value="<?=$de['roll_my_msg']['cs_etc_1']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['roll_my_msg']['cs_etc_1']?>;"></i>
                ...
                <tr>
					...
					<td class="bo-right">
						<input type="text" name="cs_name[53]" value="roll_msg" readonly size="15"/>
					</td>
					<td>
						배경색상&nbsp;&nbsp; <input type="text" name="cs_value[53]" value="<?=$de['roll_msg']['cs_value']?>" size="8"/>
						<i class="color-preview" style="background: <?=$de['roll_msg']['cs_value']?>;"></i>
						&nbsp;&nbsp;
						폰트색상&nbsp;&nbsp; <input type="text" name="cs_etc_1[53]" value="<?=$de['roll_msg']['cs_etc_1']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['roll_msg']['cs_etc_1']?>;"></i>
                ...
                <tr>
					...
					<td class="bo-right">
						<input type="text" name="cs_name[54]" value="roll_secret" readonly size="15"/>
					</td>
					<td>
						배경색상&nbsp;&nbsp; <input type="text" name="cs_value[54]" value="<?=$de['roll_secret']['cs_value']?>" size="8"/>
						<i class="color-preview" style="background: <?=$de['roll_secret']['cs_value']?>;"></i>
						&nbsp;&nbsp;
						폰트색상&nbsp;&nbsp; <input type="text" name="cs_etc_1[54]" value="<?=$de['roll_secret']['cs_etc_1']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['roll_secret']['cs_etc_1']?>;"></i>
	...
	<div class="tbl_frm01 tbl_wrap">
		<table>
            ...
            <tr>
					...
					<td class="bo-right">
						<input type="text" name="cs_name[56]" value="cal_tooltip" readonly size="15"/>
					</td>
					<td>
						배경색상&nbsp;&nbsp; <input type="text" name="cs_value[56]" value="<?=$de['cal_tooltip']['cs_value']?>" size="8"/>
						<i class="color-preview" style="background: <?=$de['cal_tooltip']['cs_value']?>;"></i>
						&nbsp;&nbsp;
						폰트색상&nbsp;&nbsp; <input type="text" name="cs_etc_1[56]" value="<?=$de['cal_tooltip']['cs_etc_1']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['cal_tooltip']['cs_etc_1']?>;"></i>
				...
				<tr>
					...
					<td class="bo-right">
						<input type="text" name="cs_name[57]" value="cal_date" readonly size="15"/>
					</td>
					<td>
						평일 색&nbsp;&nbsp; <input type="text" name="cs_value[57]" value="<?=$de['cal_date']['cs_value']?>" size="8"/>
						<i class="color-preview" style="background: <?=$de['cal_date']['cs_value']?>;"></i>
						&nbsp;&nbsp;
						토요일 색&nbsp;&nbsp; <input type="text" name="cs_etc_1[57]" value="<?=$de['cal_date']['cs_etc_1']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['cal_date']['cs_etc_1']?>;"></i>
                        &nbsp;&nbsp;
                        일요일 색&nbsp;&nbsp; <input type="text" name="cs_etc_2[57]" value="<?=$de['cal_date']['cs_etc_2']?>" size="8"/>
						<i class="color-preview" style="background: <?=$de['cal_date']['cs_etc_2']?>;"></i>
					</td>
				</tr>
                ...
                <tr>
					...
					<td class="bo-right">
						<input type="text" name="cs_name[58]" value="cal_grid" readonly size="15"/>
					</td>
					<td>
						기본 색상&nbsp;&nbsp; <input type="text" name="cs_value[58]" value="<?=$de['cal_grid']['cs_value']?>" size="8"/>
						<i class="color-preview" style="background: <?=$de['cal_grid']['cs_value']?>;"></i>
						&nbsp;&nbsp;
						금일 색상&nbsp;&nbsp; <input type="text" name="cs_etc_1[58]" value="<?=$de['cal_grid']['cs_etc_1']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['cal_grid']['cs_etc_1']?>;"></i>
                        비활성 색상&nbsp;&nbsp; <input type="text" name="cs_etc_2[58]" value="<?=$de['cal_grid']['cs_etc_2']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['cal_grid']['cs_etc_2']?>;"></i>
                        테두리&nbsp;&nbsp; <input type="text" name="cs_etc_3[58]" value="<?=$de['cal_grid']['cs_etc_3']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['cal_grid']['cs_etc_3']?>;"></i>
		...
		<table>
			...
			<tbody>
                ...
                <tr>
					...
					<td class="bo-right">
						<input type="text" name="cs_name[45]" value="menu_option" readonly size="15"/>
					</td>
					<td>
						색상코드&nbsp;&nbsp; <input type="text" name="cs_value[45]" value="<?=$de['menu_option']['cs_value']?>" size="8"/>
						<i class="color-preview" style="background: <?=$de['menu_option']['cs_value']?>;"></i>
						&nbsp;&nbsp;
						마우스 오버&nbsp;&nbsp; <input type="text" name="cs_etc_1[45]" value="<?=$de['menu_option']['cs_etc_1']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['menu_option']['cs_etc_1']?>;"></i>
                        &nbsp;&nbsp;
						버튼크기&nbsp;&nbsp; <input type="text" name="cs_etc_2[45]" value="<?=$de['menu_option']['cs_etc_2']?>" size="5"/> px
					</td>
				</tr>
				<tr>
					<th scope="row">
                ...
                <tr>
					...
					<td class="bo-right">
						<input type="text" name="cs_name[55]" value="tooltip" readonly size="15"/>
					</td>
					<td>
						배경색상&nbsp;&nbsp; <input type="text" name="cs_value[55]" value="<?=$de['tooltip']['cs_value']?>" size="8"/>
						<i class="color-preview" style="background: <?=$de['tooltip']['cs_value']?>;"></i>
						&nbsp;&nbsp;
						폰트색상&nbsp;&nbsp; <input type="text" name="cs_etc_1[55]" value="<?=$de['tooltip']['cs_etc_1']?>" size="10"/>
						<i class="color-preview" style="background: <?=$de['tooltip']['cs_etc_1']?>;"></i>
