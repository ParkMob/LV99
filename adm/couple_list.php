...
<form name="fpointlist2" method="post" id="fpointlist2" action="./couple_main_update.php" autocomplete="off">
	<input type="hidden" name="sst" value="<?php echo $sst ?>">
	<input type="hidden" name="sod" value="<?php echo $sod ?>">
	<input type="hidden" name="sfl" value="<?php echo $sfl ?>">
	<input type="hidden" name="stx" value="<?php echo $stx ?>">
	...
	<section id="anc_003">
		<h2 class="h2_frm">메인 커플</h2>


        <table>
			<caption>메인 커플</caption>
			<colgroup>
            ...
            <th scope="row"><label for="cf_1">메인 커플</label></th>
			<td colspan="3">  <?php echo get_couple_select($config['cf_1']); ?></td>
...
?>
	...
	<div class="tbl_frm01 tbl_wrap">
		<table>
			...
			<tbody>
            <tr>
					<th scope="row"><label for="co_title">커플명<strong class="sound_only">필수</strong></label></th>
					<td><input type="text" name="co_title" id="co_title" required class="required" style="width: 300px;"></td>
				</tr>
                <tr>
					<th scope="row"><label for="co_desc">커플설명<strong class="sound_only">필수</strong></label></th>
					<td><input type="text" name="co_desc" id="co_desc" required class="required" style="width: 300px;"></td>
				</tr>
                <tr>
