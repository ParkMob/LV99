...
$sql = " insert into `{$table_prefix}config`
            set cf_title = '".$_POST['community_title']."',
                cf_theme = 'basic',
                cf_admin = '$admin_id',
                cf_admin_email = '$admin_email',
                cf_admin_email_name = '".$_POST['community_title']."',
                cf_use_point = '1',
                cf_use_copy_log = '0',
                cf_login_point = '0',
                ...
                cf_cert_limit = '2',    
                cf_stipulation = '회원가입시 홈페이지 약관으로 출력됩니다.',
				cf_side_title = '소속',
				cf_class_title = '종족',
				cf_character_count = '999999999',
				cf_search_count = '5',
				cf_money = '화폐',
				cf_money_pice = '원',
				cf_exp_name = '경험치',
...
$sql = " insert into `{$table_prefix}group`
            (`gr_id`, `gr_subject`, `gr_device`, `gr_admin`, `gr_use_access`, `gr_order`, `gr_1_subj`, `gr_2_subj`, `gr_3_subj`, `gr_4_subj`, `gr_5_subj`, `gr_6_subj`, `gr_7_subj`, `gr_8_subj`, `gr_9_subj`, `gr_10_subj`, `gr_1`, `gr_2`, `gr_3`, `gr_4`, `gr_5`, `gr_6`, `gr_7`, `gr_8`, `gr_9`, `gr_10`) VALUES
			('original','$community_title','both', '', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
			 ";
sql_query($sql, true, $dblink);
...
$sql = " INSERT INTO `{$table_prefix}css_config` (`cs_id`, `cs_name`, `cs_value`, `cs_descript`, `cs_etc_1`, `cs_etc_2`, `cs_etc_3`, `cs_etc_4`, `cs_etc_5`, `cs_etc_6`, `cs_etc_7`, `cs_etc_8`, `cs_etc_9`, `cs_etc_10`) VALUES
		...
		(3, 'background', '".$g5_path['url']."/img/bak_admin_login_top_pattern.png', '', '', '', '', '', '', '', '', '', '', ''),
		(4, 'm_background', '".$g5_path['url']."/img/bak_admin_login_top_pattern.png', '', '', '', '', '', '', '', '', '', '', ''),
		(5, 'menu_pos', 'top', '', '', '', '', '', '', '', '', '', '', ''),
		(6, 'menu_width', '200', '', '', '', '', '', '', '', '', '', '', ''),
		(7, 'menu_height', '50', '', '', '', '', '', '', '', '', '', '', ''),
		(8, 'menu_background', '', '', '', '', '', '', '', '', '', '', '', ''),
		...
		(43, 'mmb_counter', '', '', '', '', '', '', '', '', '', '', '', ''),
        (44, 'cate_background', '#ffffff', '', '#29c7c9', '12', '#ffffff', '#ffffff', '12', '', '', '', '', ''),
        (45, 'cate_join', '◆', '', '#ffffff', '12', '', '', '', '', '', '', '', ''),
        (46, 'menu_option', '#29c7c9', '', '#ffffff', '15', '', '', '', '', '', '', '', ''),
        (47, 'm_slide_background', '', 'rgba(255, 255, 255, 1)', '', '', '', '', '', '', '', '', '', ''),
        (48, 'm_slide_menu', '#afdde5', '', '12', '#ffffff', '#afdde5', '1', '', '', '', '', '', ''),
        (49, 'm_slide_cate', '#afdde5', '', '10', '#ffffff', '#afdde5', '1', '', '', '', '', '', ''),
        (50, 'm_slide_btn', '#afdde5', '', '16', '', '', '', '', '', '', '', '', ''),
        (51, 'roll_desc', 'rgba(0,0,0,0)', '', '#3b3b3b', '', '', '', '', '', '', '', '', ''),
        (52, 'roll_em', '#7fbbc6', '', 'white', '', '', '', '', '', '', '', '', ''),
        (53, 'roll_my_msg', 'rgb(240, 240, 240)', '', '#3b3b3b', '', '', '', '', '', '', '', '', ''),
        (54, 'roll_msg', '#000000', '', '#3b3b3b', '', '', '', '', '', '', '', '', ''),
        (55, 'roll_secret', '#afdde5', '', '#3b3b3b', '', '', '', '', '', '', '', '', ''),
        (56, 'tooltip', '#3b3b3b', '', '#ffffff', '', '', '', '', '', '', '', '', ''),
        (57, 'cal_tooltip', '#3b3b3b', '', '#ffffff', '', '', '', '', '', '', '', '', ''),
        (58, 'cal_date', '#4c4c4c', '', '#9fbfe6', '#e39595', '', '', '', '', '', '', '', ''),
        (59, 'cal_grid', 'rgba(255,255,255,1)', '', 'rgba(140, 215, 228, 0.15)', 'rgba(236, 236, 236, 0.3)', '#ddd', '', '', '', '', '', '', '');";
sql_query($sql, true, $dblink);
...
fwrite($f, "\$g5['cal_table'] = G5_TABLE_PREFIX.'cal'; // 캘린더 정보 테이블\n");
