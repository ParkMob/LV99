...
CREATE TABLE IF NOT EXISTS `avo_board` (
  ...
  `bo_1_subj` varchar(255) NOT NULL DEFAULT '멤버',
  `bo_2_subj` varchar(255) NOT NULL DEFAULT '페이지',
  ...
  `bo_order_whippy` int(11) NOT NULL DEFAULT '1',
...
--
-- Table structure for table `avo_cal`
--

DROP TABLE IF EXISTS `avo_cal`;
CREATE TABLE IF NOT EXISTS `avo_cal` (
  `cal_id` varchar(20) NOT NULL DEFAULT '',
  `cal_name` varchar(255) NOT NULL DEFAULT '',
  `cal_add` longtext NOT NULL,
  `cal_color` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`cal_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `avo_couple` (
  ...
  `co_order` int(11) NOT NULL DEFAULT '0',
   `co_title` varchar(255) NOT NULL DEFAULT '',
   `co_desc` varchar(255) NOT NULL DEFAULT '',
