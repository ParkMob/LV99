	...
	<table class="theme-form">
		...
		<? if($ad['ad_use_thumb']) { ?>
			...
			<tr>
				...
				<? if($ch['ch_thumb']) { ?>
                    ...
                    <a href="#" class="ui-btn" id="del_thumb"><?=$ad['ad_text_thumb']?> 이미지 삭제</a>
		...
		<? if($ad['ad_use_head']) { ?>
			...
			<tr>
				...
				<? if($ch['ch_head']) { ?>
                    ...
                    <a href="#" class="ui-btn" id="del_head"><?=$ad['ad_text_head']?> 이미지 삭제</a>
		...
		<? if($ad['ad_use_body']) { ?>
			...
			<tr>
				...
				<? if($ch['ch_body']) { ?>
                    ...
                    <a href="#" class="ui-btn" id="del_body"> 	<?=$ad['ad_text_body']?> 이미지 삭제</a>
        ...
        <tr>
				...
				<td>
					...
					<input type="file" name="ch_music_file"/>

					<input type="hidden" name="ch_music" value="<?php echo $ch['ch_music'] ?>" />

	

				<? if($ch['ch_music']) { ?>

					<a href="<?=$ch['ch_music']?>" class="ui-btn" target="_blank">

						음악 확인

					</a>

                    <a href="#" class="ui-btn" id="del_music">음악 삭제</a>
...
<? } ?>
	...
	<div class="txt-center">
		...
		<a href="javascript:history.back();" class="ui-btn">취소</a>
...
$("#del_thumb").click(function(){
    ...
    var delConfirm = confirm('두상 이미지를 삭제하시겠습니까?');

    

    if (delConfirm) {

    $("input[name=ch_thumb]").val("");

    $("input[name=ch_thumb_file]").val("");
...
$("#del_body").click(function(){



    var delConfirm = confirm('전신 이미지를 삭제하시겠습니까?');
...
$("#del_music").click(function(){



var delConfirm = confirm("음악을 삭제하시겠습니까?");
