...
echo '<link rel="stylesheet" href="'.G5_CSS_URL.'/style.profile.css">'.PHP_EOL;

echo '<link rel="stylesheet" href="'.G5_CSS_URL.'/style.css" type="text/css">'.PHP_EOL;
echo '<link rel="stylesheet" href="'.G5_CSS_URL.'/effect.css">'.PHP_EOL;
...
?>
<div class="profile-title" style="height: 0;
    text-align: center;
    margin: 50px auto;">옷장</div>
<div class="theme-box">
